  ...
  const handleVerify = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      if (otpValue === generatedOTP) {
        // Get password data from navigation state
        ...
        navigate('/app/account-settings/password/success', {
          replace: true,
          state: state?.passwordData ? { passwordData: state.passwordData } : {}
        });
      } else {
        ...
        <div className="w-full max-w-md">
          ...
          <div className="backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-blue-200/50 relative bg-white">
            ...
            <form onSubmit={handleVerify} className="pt-8">
              {/* Title */}
              <div className="text-center mb-8">
                <h2 className="text-2xl font-bold text-[#022466] mb-2">Password</h2>
                <h3 className="text-xl font-bold text-[#022466] mb-2">OTP Verification</h3>
                <p className="text-gray-600">We've sent a 6-digit code for password change verification</p>
                {generatedOTP && (
