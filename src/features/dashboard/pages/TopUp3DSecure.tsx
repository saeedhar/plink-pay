...
import passwordIcon from '../../../assets/topup/password.svg';

const TopUp3DSecure: React.FC = () => {
  ...
  const handleVerify = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('✅ 3D Secure OTP verified:', otpCode);
  ...
  const handleResend = async () => {
    ...
    console.log('✅ 3D Secure OTP resent');
  };
          ...
          >
            ...
            <form onSubmit={handleVerify} className="pt-8">
              ...
              <div className="flex justify-center mb-6">
                <img src={passwordIcon} alt="3D Secure" style={{ width: 69, height: 69 }} />
              </div>

              {/* Title */}
              <div className="text-center mb-8">
                <h2 className="text-2xl font-bold text-[#022466] mb-2">3D Secure Verification</h2>
                <p className="text-gray-600">
                  A verification code has been sent to your<br />
                  registered mobile number ending with 1234.<br />
                  Please enter it below to confirm<br />
                  your card top-up.
                </p>
              </div>
