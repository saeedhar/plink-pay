...
const ChangeCardPINFinalSuccess: React.FC = () => {
          ...
          <div className="backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-blue-200/50 relative bg-white">
            ...
            <div className="text-center mb-6">
              <h2 className="text-2xl font-bold text-[#022466] mb-4">
                PIN Changed<br />Successfully
              </h2>
              <p className="text-gray-600 text-base leading-relaxed">
                Your card PIN has been successfully updated. Thank you for choosing Tayseer Wallet Company.
              </p>
            </div>
...
export default ChangeCardPINFinalSuccess;
