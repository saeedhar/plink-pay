...
const UpdateEmailOTP: React.FC = () => {
  ...
  useEffect(() => {
    // Get email, sessionId, and otpCode from navigation state
    ...
    if (state?.sessionId) {
      ...
      setTimeout(() => {
        navigate('/app/account-settings/email');
      }, 2000);
      return;
    }
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      // Re-initiate email update to get new OTP
  ...
  const handleVerify = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('Failed to verify email update:', error);
        ...
        <div className="w-full max-w-md">
          ...
          <div className="backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-blue-200/50 relative bg-white">
            ...
            <form onSubmit={handleVerify} className="pt-8">
              {/* Title */}
              <div className="text-center mb-8">
                <h2 className="text-2xl font-bold text-[#022466] mb-2">Email</h2>
