...
const DeactivateDeviceSuccess: React.FC = () => {
  ...
  useEffect(() => {
    const handlePopState = (e: PopStateEvent) => {
      ...
      navigate('/app/account-settings/devices', { replace: true });
    };
            ...
            <div className="text-center">
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600">
                  The device{' '}
                  <span className="font-semibold text-[#022466]">{deviceName}</span> has been successfully deactivated on{' '}
...
export default DeactivateDeviceSuccess;
