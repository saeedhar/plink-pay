...
const CardActivationSuccess: React.FC = () => {
            ...
            <div className="text-center">
              ...
              <div className="text-center mb-6">
                <h2 className="text-2xl font-bold text-[#022466] mb-4">
                  Card Activated<br />Successfully
                </h2>
                <p className="text-[#022466] text-base leading-relaxed">
                  Dear customer, your physical card has been successfully activated on{' '}
                  <span className="font-medium">({getCurrentDate()})</span>. You can now start using your card. Thank you for choosing Tayseer Wallet Company.
                </p>
              </div>
              ...
              <div className="flex justify-center">
                <button
                  onClick={handleDone}
                  className="w-full max-w-xs py-3 px-6 rounded-xl border-2 border-[#022466] bg-white text-[#022466] font-medium hover:bg-gray-50 transition-all"
                >
                  Done
                </button>
              </div>
